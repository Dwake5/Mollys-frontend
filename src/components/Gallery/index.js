...
class Photos extends React.Component {
  ...
  handlePhotoIndexState = () => {
    const pictureQuantity = this.state.listOfImages.length;
  ...
  startTimeout = () => {
    ...
    const timer = width < 601 ? 2000 : 3000;
    this.timerID = setInterval(() => this.handlePhotoIndexState(), timer);
      ...
      <Div>
        ...
        {currentUser && (
          <>
            ...
            <AddPhotosButton
              onClick={() =>
                this.setState({ addingPhotos: !this.state.addingPhotos })
              }
            >
              {" "}
              Add photo's
        ...
        {isOpen && (
          <Lightbox
            ...
            prevSrc={
              listOfImages[
                (photoIndex + listOfImages.length - 1) % listOfImages.length
              ]
            }
