...
import { Div, BusinessDiv, BusinessDivLessBot, h3, ImgDivLeft, ImgDivRight, BusinessText, BusinessImg, AnchorLeft, Picture, Anchor, LinkDiv, Address, ImgP} from './style'
        ...
        <Div>
            ...
            <BusinessDiv>
                ...
                <BusinessText>
                    ...
                    <ImgP><img height='15px' alt='phone icon' src={phone}/> 07795 248 426</ImgP>
                    <LinkDiv>
            ...
            <BusinessDiv>
                <BusinessText>
                    ...
                    <ImgP><img height='15px' alt='phone icon' src={phone}/> 07906 481 618</ImgP>
                    <LinkDiv>
            ...
            <BusinessDiv>
                ...
                <BusinessText>
                    ...
                    <ImgP><img height='15px' alt='phone icon' src={phone}/> 07593 875 748</ImgP>
                    <LinkDiv>
            ...
            <BusinessDivLessBot>
                <BusinessText>
                    ...
                    <ImgP><img height='15px' alt='phone icon' src={phone}/> 07960 823 776</ImgP>
                    <LinkDiv>
